...
fetch(url)
    ...
    .then(function (data) {
        ...
        div_competences.innerHTML = "<input type='checkbox' id='selectionner_tout' name=''   />" +
        ...
        competences.map(function (competences) {
            ...
            div_competences.innerHTML += "<input type='checkbox' id='competence_" + competences.id + "'   name=''   />" +
